              ...
              <div className={styles.containerTwoInput}>
                  ...
                  <select onChange={(e) => setPrice(e.target.value)}>
                    ...
                    {tool && (
                      <>
                        ...
                        <option value={formateNumber(tool.twentyOneDays)}>
                          3 semanas (21 dias)
                        </option>
                ...
                {tool.name && tool.name.toLowerCase().includes('andaime') && (
                  <div>
                    ...
                    <p className={styles.pCalculate} onClick={calculateQuantityOfAndaime}>
                      Calcular
                    </p>
                  </div>
                )}
                    ...
                    listItems.map((item, index) => (
                      <li key={index}>
                        ...
                        <input
                          ...
                          value={item.quantity}
                          onChange={(e) =>
                            handleChangeItem(index, 'quantity', parseFloat(e.target.value))
                          }
                          placeholder='Quantidade'
                          min={1}
                        />
                        <input
                          ...
                          value={item.price}
                          onChange={(e) =>
                            handleChangeItem(index, 'price', parseFloat(e.target.value))
                          }
                          placeholder='Preço'
                          min={1}
                        />
