...
const RegisterClient = ({ createClient, errors, createClientPj, errorsPj }) => {
  ...
  return (
    <div className={styles.container}>
      ...
      {success && !errors && !errorsPj && <p className={styles.success}>{success}</p>}
      ...
      <form className={styles.form} onSubmit={handleSubmit}>
        ...
        {selectedForm === 'pf' && (
          <>
            <div className={styles.grid}>
              ...
              <div className={styles.inputGroup}>
                <label>CEP</label>
                <input type='text' value={addresses.cep} onChange={handleCepChange} />
                {errors && (
                  <p className={styles.errorMsg}>
        ...
        {selectedForm === 'pj' && (
          <>
            <div className={styles.grid}>
              ...
              <div className={styles.inputGroup}>
                <label>CNPJ</label>
                <input type='text' maxLength={18} value={cnpj} onChange={handleCnpjChange} />
                {errorsPj && (
                  <p className={styles.errorMsg}>
        ...
        <div className={styles.grid}>
          ...
          <div className={styles.inputGroup}>
            <label>Cidade</label>
            <input type='text' name='city' value={addresses.city} onChange={handleInputChange} />
          </div>
          <div className={styles.inputGroup}>
            <label>Estado</label>
            <input type='text' name='state' value={addresses.state} onChange={handleInputChange} />
          </div>
          <div className={styles.inputGroup}>
