                ...
                <form className={styles.formContainer} onSubmit={handleSubmit}>
                    <div className={styles.form}>
                        ...
                        <div className={styles.inputContainer}>
                            ...
                            <input type="text" name="socialReason" id="socialReason" onChange={e => setSocialReason(e.target.value)} value={socialReason} />
                            {errors && errors.length > 0 && (
                                <p style={{ color: "red" }}>{errors.filter(error => error.includes("razão social"))}</p>)}
                        </div>
                        <div className={styles.inputContainer}>
                            <label htmlFor="cnpj">CNPJ</label>
                            <input type="text" name="cnpj" id="cnpj" onChange={e => setCnpj(e.target.value)} value={cnpj} />
                            {errors && errors.length > 0 && (
                        ...
                        <div className={styles.inputContainer}>
                            ...
                            <input type="text" name="municipalRegistration" id="municipalRegistration" onChange={e => setMunicipalRegistration(e.target.value)} value={municipalRegistration} />
                            {errors && errors.length > 0 && (
                                <p style={{ color: "red" }}>{errors.filter(error => error.includes("O registro do município"))}</p>)}
                        </div>
                        <div className={styles.inputContainer}>
                            <label htmlFor="stateRegistration">Registro Estadual</label>
                            <input type="text" name="stateRegistration" id="stateRegistration" onChange={e => setStateRegistration(e.target.value)} value={stateRegistration} />
                            {errors && errors.length > 0 && (
                                <p style={{ color: "red" }}>{errors.filter(error => error.includes("O Registro do estado"))}</p>)}
                            
                        </div>
                        <div className={styles.inputContainer}>
                            <label htmlFor="fantasyName">Nome fantasia</label>
                            <input type="text" name="fantasyName" id="fantasyName" onChange={e => setFantasyName(e.target.value)} value={fantasyName} />
                            {errors && errors.length > 0 && (
                                <p style={{ color: "red" }}>{errors.filter(error => error.includes("fantasia"))}</p>)}
                        </div>
                        <div className={styles.inputContainer}>
                            <label htmlFor="street">Endereço</label>
                            <input type="text" name="street" id="street" value={addresses.street} onChange={handleInputChange} />
